...
API_ID = int(getenv("23562152"))
API_HASH = getenv("fcbbb683bf94e788c3cba5425e8de58e")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("8635329978:AAEagSJ125oNRPGvIKqcqRUc56OdMyBqp-s")
...
OWNER_ID = int(getenv("OWNER_ID", 6640962588))
